        ...
        <article className="chapter-content">
          <div className="chapter-prose" style={{ paddingBottom: "var(--sp-10)" }}>
            ...
            <p style={{
              ...
              <Link href="/ktalk/manuscript/intro" style={{ color: "var(--ink-muted)", textDecoration: "none" }}>
                Read in English →
              </Link>
            </p>
          </div>
          ...
          <div className="chapter-body">
            ...
            <SlideRow image="/mindbook/ktalk/slides/ch1-career-path.png" alt="Career path: GoPro → Google Product Designer → Google AI UX Engineer → SAP Product Designer → SAP Principal PM" caption="GoPro · Google · Google AI · SAP Designer · SAP PM">
            ...
            <SlideRow image="/mindbook/ktalk/slides/ch1-ai-noise.png" alt="Flood of AI tools on the left, person at laptop thinking about coordination on the right">
            ...
            <SlideRow image="/mindbook/ktalk/slides/ch1-coordination-era.png" alt="Designer coding, PM prototyping, engineer giving feedback, AI contributing — all converging toward a shared goal">
