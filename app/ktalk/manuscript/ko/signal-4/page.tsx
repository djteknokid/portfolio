...
export default function Chapter12Ko() {
  return (
        ...
        <article className="chapter-content">
          <div className="chapter-prose" style={{ paddingBottom: "var(--sp-10)" }}>
            ...
            <div style={{ position: "relative", marginTop: "var(--sp-8)" }}>
              ...
              <h1 className="chapter-title" style={{ position: "relative", zIndex: 1 }}>신호 4 — 불만의 변화</h1>
            </div>
            <p style={{
              ...
              <Link href="/koreatalk/manuscript/signal-4" style={{ color: "var(--ink-muted)", textDecoration: "none" }}>
                Read in English →
              </Link>
            </p>
          </div>
