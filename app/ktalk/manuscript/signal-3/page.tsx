      ...
      <main className="chapter-page">
        <article className="chapter-content">
          <div className="chapter-prose" style={{ paddingBottom: "var(--sp-10)" }}>
            <p className="chapter-part-label" style={{ color: ACCENT }}>Chapter 11</p>
            <p className="chapter-part-subtitle">The Coordination Era · 조율의 시대</p>
            <div style={{ position: "relative", marginTop: "var(--sp-8)" }}>
              <div className="chapter-ghost-number" aria-hidden="true" style={{ position: "absolute", top: "-0.15em", left: "-0.05em", zIndex: 0 }}>11</div>
              <h1 className="chapter-title" style={{ position: "relative", zIndex: 1 }}>
                Signal 3 —<br />The Complaint Changed
              </h1>
            </div>
          </div>
          ...
          <div className="chapter-body">
            ...
            <SlideRow
              image="/mindbook/koreatalk/slides/ch11-complaints.png"
              alt="Three people at a conference table arguing in front of a massive complex flowchart on the wall behind them"
            >
            ...
            <p>All three signals pointed to the same place.</p>
