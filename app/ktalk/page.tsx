...
const slides: SlideData[] = [
  ...
  /* ── CH 8 ── */
  {
    ...
    layout: "split-top",
    script: `좋습니다.\n\n지금까지 이야기한 내용은 어떻게 보면 전부 이론이었습니다.\n\n사진 이야기.\n\n농구 이야기.\n\n패턴.\n\n역사.\n\n흥미로운 이야기들이었지만,\n\n아직은 조금 멀리 있는 이야기였습니다.\n\n그런데 이제부터는 조금 다릅니다.\n\n이제 제가 실제로 목격한 이야기를 해보려고 합니다.\n\n트위터에서 본 것도 아닙니다.\n\n링크드인에서 본 것도 아닙니다.\n\n팟캐스트에서 들은 것도 아닙니다.\n\n실제 제품 팀에서,\n\n실제 프로젝트를 하면서,\n\n제가 직접 경험한 이야기입니다.\n\n지난 1년 동안 저는 대기업 안에서 AI 제품을 만들고 있었습니다.\n\n그리고 솔직히 말하면,\n\n저는 앞으로 무슨 일이 일어날지 어느 정도 알고 있다고 생각했습니다.\n\nAI가 팀을 더 빠르게 만들 것이라고 생각했습니다.\n\n더 많은 것을 만들고,\n\n더 많은 프로토타입을 만들고,\n\n더 많은 실험을 하고,\n\n더 많은 것을 출시하게 될 것이라고 생각했습니다.`,
  },
  {
    id: 25,
    ...
    layout: "split-top",
    script: `그리고 실제로 그렇게 되었습니다.\n\n정말 빨라졌습니다.\n\n그런데 예상하지 못했던 일이 하나 있었습니다.\n\n사람들이 더 많이 만들수록,\n\n결정은 더 어려워졌습니다.\n\n이상한 상황들이 계속 생기기 시작했습니다.\n\n어떤 디자이너는\n\n정말 훌륭한 End-to-End 플로우를 만들어 왔습니다.\n\n깊이 고민했고,\n\n디테일도 좋았고,\n\n완성도도 높았습니다.\n\n그런데 이상하게도\n\n그 결과물이 팀을 앞으로 나아가게 만들지 못했습니다.\n\n대신 이런 이야기가 나오기 시작했습니다.\n\n"AI는 디자인을 못해요."\n\n"이 프로토타입은 충분히 좋지 않아요."\n\n"이건 올바른 방식이 아니에요."\n\n어느 순간부터\n\n제품 이야기를 하지 않고 있었습니다.\n\n결과물에 대해 싸우고 있었습니다.\n\n반대로 저도 프로토타입을 여러 개 만들어서 회의에 가져가곤 했습니다.\n\n제가 정답이라고 생각해서가 아닙니다.\n\n옵션을 만들고 싶었기 때문입니다.\n\n피드백을 받고 싶었기 때문입니다.\n\n탐색하고 싶었기 때문입니다.\n\n그런데 가끔은\n\n어떤 방향이 좋은지 이야기하기보다\n\n프로세스에 대한 토론이 시작되었습니다.\n\n플로우차트를 먼저 만들어야 하지 않을까?\n\n퍼소나를 먼저 정의해야 하지 않을까?\n\n전통적인 디자인 프로세스를 먼저 따라야 하지 않을까?\n\n그리고 다시,\n\n우리는 결정을 하고 있지 않았습니다.\n\n결정하는 방법에 대해 토론하고 있었습니다.\n\n또 한 번은\n\n한 엔지니어가 저를 따로 불렀습니다.\n\n직접 코드로 만들어 본 인터랙션을 보여주었습니다.\n\n정말 좋은 아이디어였습니다.\n\n원래라면 팀 전체가 함께 이야기했어야 할 아이디어였습니다.\n\n그런데 이상하게도\n\n그 아이디어가 들어갈 자리가 없었습니다.\n\n결국 그 아이디어는\n\n그 엔지니어의 노트북 안에만 남아 있었습니다.\n\n이런 장면들을 반복해서 보다 보니\n\n하나의 패턴이 보이기 시작했습니다.\n\n회의가 달라졌습니다.\n\n더 나빠진 것은 아닙니다.\n\n그냥 달라졌습니다.`,
  },
  {
    id: 26,
    ...
    layout: "split-top",
    script: `아이디어가 더 많아졌습니다.\n\n프로토타입이 더 많아졌습니다.\n\n산출물이 더 많아졌습니다.\n\n옵션이 더 많아졌습니다.\n\n방향성이 더 많아졌습니다.\n\n의견도 더 많아졌습니다.\n\n모든 것이 더 많아졌습니다.\n\n그런데 이상하게도…\n\n명확성은 줄어들었습니다.\n\nAI가 신기한 이유는\n\n많은 실행 문제를 해결해 주기 때문입니다.\n\n그런데 문제 하나를 해결할 때마다\n\n다른 문제 하나를 드러내는 것 같았습니다.\n\n더 많은 결과물.\n\n더 많은 충돌.\n\n더 적은 명확성.\n\n그리고 그 순간 깨달았습니다.\n\n이건 실행의 문제가 아니구나.\n\n이건 조율의 문제구나.\n\n그 후부터 저는 같은 패턴을 여기저기서 보기 시작했습니다.\n\n실리콘밸리에서.\n\n디자인 커뮤니티에서.\n\nPM과 디자이너의 대화에서.\n\n채용 시장에서.\n\n컨퍼런스 발표에서.\n\n사람들은 점점 이렇게 묻지 않았습니다.\n\n"어떻게 더 만들 수 있을까?"\n\n대신 이런 질문을 하기 시작했습니다.\n\n"우리는 어떻게 결정해야 하지?"\n\n그리고 한 번 보기 시작하니까,\n\n어디를 가도 보였습니다.\n\n그래서 저는 이 현상이 우리 팀만의 문제가 아니라고 확신하게 되었습니다.\n\n그 확신을 만들어준 세 가지 신호를 보여드리겠습니다.`,
  },
