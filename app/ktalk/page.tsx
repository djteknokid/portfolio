...
const slides: SlideData[] = [
  ...
  /* ── CH 2 ── */
  {
    ...
    layout: "split-top",
    script: `제가 여기까지 오게 된 이야기를 조금 드릴게요.\n\n2년 전, 저는 "Designer in 2027" 이라는 1인극 형태의 발표를 했습니다.\n\n전제는 굉장히 단순했습니다.\n\nAI가 대부분의 실행을 담당하게 되고, 디자이너는 AI가 잘하지 못하는 일에 더 많은 시간을 쓰게 될 것이라는 이야기였습니다.\n\n사용자를 만나고, 영감을 얻고, 점들을 연결하고, 의사결정을 하고, AI를 직접 조작하는 사람이 아니라 AI를 디렉팅하는 사람이 된다는 이야기였습니다.\n\n당시에는 조금 과격하게 들렸습니다.\n\n농담이라고 생각한 분들도 있었고, 솔직히 농담이었으면 좋겠다고 생각한 분들도 있었습니다.`,
  },
  {
    id: 6,
    ...
    layout: "split-top",
    script: `그리고 최근에 저는 또 한 번 움직였습니다.\n\n디자인에서 프로덕트 매니지먼트로 역할을 바꿨습니다.\n\n디자인이 죽었다고 생각해서도 아니고, 디자인할 것이 없어져서도 아닙니다.\n\n계속 같은 질문을 했기 때문입니다.\n\n지금 병목은 어디에 있는가?\n\n지금 마찰은 어디에서 발생하는가?\n\n지금 팀을 가장 느리게 만드는 것은 무엇인가?\n\n이 질문을 따라가다 보니, 매번 다른 곳에 도착하게 되었습니다.\n\n2024년에는: 디자이너는 AI를 사용하는 사람이 아니라 AI를 디렉팅하는 사람이 될 것이다.\n\n2025년에는: 디자이너는 점점 더 코드를 통해 만들게 될 것이다.\n\n그리고 2026년, 제가 보고 있는 다음 병목은 이것입니다.\n\n조율. 실행이 아닙니다. 프로토타이핑도 아닙니다. 아이디어 생성도 아닙니다. 조율입니다.\n\n이 이야기를 하는 이유는 제가 대단한 예측을 했다고 자랑하기 위해서가 아닙니다.\n\n솔직히 틀린 것도 정말 많았습니다.\n\n제가 이야기하고 싶은 것은 예측이 아니라 패턴입니다.\n\n매번 기회는 병목이 있는 곳에 나타났습니다.\n\n그리고 저는 지금 그 병목이 또 한 번 이동했다고 생각합니다.`,
  },
