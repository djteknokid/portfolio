...
const slides: SlideData[] = [
  ...
  },
  {
    ...
    layout: "split-top",
    script: `조율은 서로 다른 정보, 목표, 우선순위를 가진 사람들을 하나의 방향으로 움직이게 하는 능력입니다.\n\n원래부터 어려운 일이었습니다. 그런데 한 가지가 바뀌었습니다.\n\n예전에는 도구의 마찰이 의도치 않게 조율의 시간을 만들어 주었습니다.\n\n지금은 프로토타입도, 목업도, 코드도 이미 존재합니다. 팀은 바로 움직여야 합니다.\n\n예전에는 자연스럽게 일어나던 조율이 이제는 의도적으로 만들어져야 합니다.\n\n---\n\nAI가 강력해질수록 팀은 더 중요해졌습니다.\n\n저는 제 인생에서 가장 큰 개인 레버리지를 가지고 있습니다. 그런데도 정렬과 의사결정에 더 많은 시간을 쓰고 있습니다.\n\n창작은 풍부합니다. 조율은 희소합니다.`,
  },
  ...
  /* ── CH 13 ── */
  {
    ...
    layout: "split-top",
    script: `링크드인에 질문 하나를 올렸습니다.\n\nPM이 고품질 프로토타입을 들고 디자인 리뷰에 들어옵니다. 그렇다면 이제 UX의 역할은 무엇일까요?\n\n반응의 강도가 예상 밖이었습니다.\n\n같은 상황, 같은 결과물, 같은 기술 — 그런데 완전히 다른 결론들.\n\n이 논쟁은 AI나 디자인에 대한 논쟁이 아니었습니다. 의사결정에 대한 논쟁이었습니다.\n\n---\n\n예전에는 느린 실행이 정렬 부족을 가려주었습니다. 지금은 프로토타입이 하루 만에 나옵니다. 정렬은 그렇지 않습니다.\n\n프로토타입이 문제를 만든 것이 아닙니다. 문제를 드러낸 것입니다.\n\n병목은 이동했습니다. 업계는 이미 그것을 느끼기 시작했습니다.`,
  },
  ...
  },
  {
    ...
    layout: "split-top",
    script: `사용자 — 항상 사용자를 방 안으로 데려오세요.\n\n논의가 추상적이 될 때, 실제 사람으로 돌아오세요.\n\n이렇게 묻지 마세요: "어떤 기능을 만들어야 하나?"\n\n이렇게 물으세요: "지금 누가 어려움을 겪고 있는가?"\n\n명확성을 만드는 사람들은 사용자가 없을 때 사용자의 목소리가 됩니다.\n\n---\n\n문제 — 증상에서 멈추지 마세요.\n\n계속 파고드세요.\n\n요청은 문제가 아닙니다. 불만은 문제가 아닙니다. 해결책은 절대 문제가 아닙니다.\n\n훌륭한 조율자들은 끊임없이 호기심을 갖습니다.\n\n그들은 계속 묻습니다: "왜 이런 일이 일어나고 있는가?"\n\n팀이 근본 원인에 도달할 때까지.\n\n---\n\n성공 — 결승선에서 시작하세요.\n\n해결책을 논의하기 전에, 성공이 어떤 모습인지 알아야 합니다.\n\n성공은 지표일 수 있습니다. 행동 변화일 수 있습니다. 비즈니스 결과일 수 있습니다.\n\n하지만 반드시 눈에 보여야 합니다.\n\n모든 디자인은 가설입니다.\n\n목표는 맞는 것이 아닙니다. 목표는 배우고, 반복하고, 진실에 가까워지는 것입니다.`,
  },
  {
    id: 39,
  ...
  },
  {
    ...
    layout: "split-top",
    script: `팀이 트레이드오프를 파악했다는 것은 세 가지에 답할 수 있다는 것입니다.\n\n이점 — 우리는 무엇을 얻는가?\n\n리스크 — 무엇이 잘못될 수 있는가?\n\n수용 — 우리는 무엇을 감수할 의향이 있는가?\n\n---\n\n이점: 이 방향을 선택하면 무엇이 더 나아지는가?\n\n더 빨리 출시할 수 있을지도 모릅니다.\n\n더 많은 고객에게 닿을 수 있을지도 모릅니다.\n\n모든 트레이드오프는 명확한 장점을 가져야 합니다.\n\n---\n\n리스크: 이 선택으로 인해 무엇을 위험에 빠뜨리는가?\n\n품질이 떨어질 수 있습니다. 유연성이 줄어들 수 있습니다. 기술 부채가 생길 수 있습니다.\n\n모든 이점에는 그에 상응하는 리스크가 따릅니다.\n\n---\n\n수용: 이것이 가장 어려운 부분입니다.\n\n팀이 리스크를 파악하지 못해서가 아닙니다.\n\n팀이 리스크를 좀처럼 인정하지 않기 때문입니다.\n\n수용은 소리 내어 말하는 것을 의미합니다:\n\n네, 우리는 단점을 이해하고 있으며 그것을 받아들일 의향이 있습니다.\n\n수용 없이 트레이드오프는 이론적인 것으로 남습니다.\n\n수용이 있어야 실행 가능해집니다.\n\n---\n\n트레이드오프 없이는 모두가 모든 것을 원합니다.\n\n더 많은 기능. 더 높은 품질. 더 빠른 배포. 더 낮은 비용.\n\n그 결과는 대개 좌절이지 진전이 아닙니다.\n\n훌륭한 조율자들은 트레이드오프를 없애지 않습니다.\n\n그들은 트레이드오프를 눈에 보이게 만듭니다.`,
  },
  {
    id: 401,
    ...
    layout: "split-top",
    script: `이점 — 가치는 여러 차원에 존재합니다.\n\n많은 디자이너들은 자연스럽게 사용자 가치에 집중합니다.\n\n하지만 훌륭한 조율자는 여러 관점에서 가치를 이해합니다.\n\n사용자 가치: 마찰을 줄이는가? 시간을 절약하는가? 결과를 개선하는가?\n\n비즈니스 가치: 채택률을 높이는가? 비용을 줄이는가? 수익을 창출하는가?\n\n전략적 가치: 플랫폼을 개선하는가? 장기 전략을 지원하는가?\n\n---\n\n리스크 — 모든 결정은 새로운 문제를 만들어냅니다.\n\n목표는 리스크를 없애는 것이 아닙니다.\n\n목표는 리스크가 현실이 되기 전에 눈에 보이게 만드는 것입니다.\n\n사용자 리스크: 신뢰가 감소할 수 있는가? 채택이 저해될 수 있는가?\n\n운영 리스크: 엔지니어링 복잡성이 증가할 수 있는가? 비용이 상승할 수 있는가?\n\n전략적 리스크: 브랜드를 손상시킬 수 있는가? 회사 전략과 충돌할 수 있는가?\n\n---\n\n수용 — 모든 이점에는 결과가 따릅니다. 누군가는 그것을 감당해야 합니다.\n\n개인 수용: 나는 이 트레이드오프를 받아들일 수 있는가?\n\n팀 수용: 엔지니어링, 제품, 디자인, 리더십이 결과를 이해하고 수용하는가?\n\n조직 수용: 회사는 이 결정에 수반되는 비용, 리스크, 지연을 감당할 의향이 있는가?\n\n---\n\n이점이 이해되고, 리스크가 눈에 보이고, 결과가 수용되면,\n\n팀은 함께 앞으로 나아갈 수 있습니다.`,
  },
  {
    id: 41,
  ...
  },
  {
    ...
    layout: "split-top",
    script: `팀이 우선순위를 정했다는 것은 세 가지에 답할 수 있다는 것입니다.\n\n긴급성 — 얼마나 빨리 주의가 필요한가?\n\n고객 에스컬레이션, 규제 마감일, 경쟁사 출시 — 이것이 긴급성을 만드는 것들입니다.\n\n임팩트 — 이것이 얼마나 중요한가?\n\n사용자 혜택, 비즈니스 가치, 고통 제거 — 임팩트는 중요성을 측정합니다.\n\n노력 — 무엇이 필요한가?\n\n시간, 돈, 엔지니어링 노력, 조직의 관심 — 노력은 비용을 현실적으로 봅니다.\n\n긴급성, 임팩트, 노력이 이해되면 — 팀은 가장 중요한 것에 집중할 수 있습니다.\n\n우선순위 없이는 모든 것이 중요해집니다. 그리고 모든 것이 중요하면, 아무것도 움직이지 않습니다.`,
  },
  {
    id: 421,
    ...
    layout: "split-top",
    script: `중요한 모든 것이 긴급한 것은 아닙니다. 긴급한 모든 것이 중요한 것도 아닙니다.\n\n긴급성 마인드셋 — 지금 불이 난 것인가, 아니면 전략적으로 중요한 것인가?\n\n즉각적 긴급성: 지금 불이 나 있습니다 — 지금 당장 다뤄야 합니다.\n\n단기 긴급성: 오늘 처리하지 않으면 더 비싸집니다.\n\n전략적 긴급성: 지금은 긴급하지 않지만, 미래에 중요해질 것입니다.\n\n임팩트 마인드셋 — 결과를 바꾸는 일을 하세요.\n\n사용자 임팩트, 비즈니스 임팩트, 전략적 임팩트 — 셋 중 하나 이상에 해당해야 합니다.\n\n노력 마인드셋 — 야망은 현실을 존중해야 합니다.\n\n디자인 노력, 배포 노력, 조직 노력 — 이 세 가지가 모두 현실적일 때 움직일 수 있습니다.`,
  },
  {
    id: 43,
  ...
  },
  {
    ...
    layout: "split-top",
    script: `세 가지가 명확할 때 팀은 결정을 내린 것입니다.\n\n이해관계자 — 누가 알아야 하는가?\n\n회의실 안에만 존재하는 결정은 결정이 아닙니다.\n\n결정을 내리는 데 누구의 의견이 필요한가? 결정을 구현하는 데 누가 필요한가? 그 결과와 함께 살아가야 하는 사람은 누구인가?\n\n책임 — 누가 결과를 소유하는가?\n\n책임 없이 결정은 제안이 됩니다.\n\n많은 팀들이 결정을 내렸다고 생각합니다. 사실은 합의에만 도달한 것입니다.\n\n다음 단계 — 이제 무슨 일이 일어나는가?\n\n회의 후 아무것도 바뀌지 않으면 결정은 실제로 이루어지지 않은 것입니다.`,
  },
  {
    id: 441,
    ...
    layout: "split-top",
    script: `이해관계자 마인드셋 — 정렬은 자동으로 일어나지 않습니다.\n\n훌륭한 조율자들은 결정이 문제가 되기 전에 이해관계자 구도를 이해합니다.\n\n누구의 의견이 필요한가? 누가 실행하는가? 누가 영향을 받는가?\n\n적절한 이해관계자 없이 내려진 결정은 나중에 다시 논의되는 결정이 됩니다.\n\n책임 마인드셋 — 책임 없는 결정은 의견입니다.\n\n누군가가 결과에 대한 책임을 수용할 때 결정은 현실이 됩니다.\n\n개인 책임, 팀 책임, 조직 책임 — 각 수준에서 누가 소유하는지 명확해야 합니다.\n\n다음 단계 마인드셋 — 다음 단계가 없으면 결정은 의도일 뿐입니다.\n\n즉각적 행동, 단기 이정표, 장기 방향 — 세 수준 모두에서 무슨 일이 일어나는지 명확해야 합니다.`,
  },
  ...
  },
  {
    ...
    quote: "항상 조율이었습니다.",
    layout: "split-top",
    script: `10년을 직책을 쫓으며 살았습니다. 디자이너, 엔지니어, PM.\n\n그리고 최근에서야 그것들을 연결하는 패턴을 이해하게 되었습니다.\n\n그 패턴은 기술이 아니었습니다. 항상 조율이었습니다.\n\n---\n\nAI는 창작의 비용을 낮췄습니다. 바닥이 올라갔습니다.\n\n사진 → 그 순간의 감정. 농구 → 팀 효율성. 음악 → 노래를 둘러싼 문화.\n\n이제 제품 개발에서 — 시장은 결과물이 아니라 그 뒤에 있는 결정에 보상을 주기 시작하고 있습니다.\n\n---\n\n창작은 풍부합니다. 조율은 희소합니다.`,
  },
  {
    id: 47,
    image: `${BASE}/ch14-coordination-era.png`,
    ...
    quote: "감사합니다.",
    layout: "split-top",
    script: `조율은 배울 수 있는 역량입니다.\n\n명확성, 트레이드오프, 우선순위, 결정.\n\n네 가지가 모두 갖춰지면 팀은 움직입니다.\n\n하나가 빠지면 팀은 멈춥니다.\n\n---\n\nAI는 조율할 수 있는 사람들을 대체하지 않을 것입니다.\n\n그들을 더 가치 있게 만들 것입니다.\n\n모두가 선택지를 만들어낼 수 있을 때, 그룹이 선택하도록 돕는 사람이 필수 불가결해집니다.\n\n---\n\nAI는 바닥을 올릴 것입니다.\n\n여러분의 일은 천장을 올리는 것입니다.\n\n감사합니다.`,
  },
  ...
  /* ── Bonus Interviews ── */
  {
    ...
    layout: "typo",
    quadrants: [
      { q: "Q1", a: "AI 툴을 사용하기 시작한 이후, 일상적인 루틴에서 가장 크게 바뀐 것은 무엇인가요?" },
      { q: "Q2", a: "PM이나 엔지니어가 이미 만들어진 무언가를 들고 왔을 때, 디자이너로서 어떻게 반응하시나요?" },
      { q: "Q3", a: "지금 이 시점에 주니어 디자이너들에게 어떤 역량을 키우라고 조언하시겠어요?" },
      { q: "Q4", a: "AI가 디자인 프로세스에 들어온 이후, PM 및 엔지니어링과의 관계는 어떻게 변했나요?" },
    ],
  ...
  },
  {
    ...
    layout: "typo",
    quadrants: [
      { q: "AI 이후 루틴에서 가장 크게 바뀐 것은?", a: "생각을 결과물로 만드는 일보다 다른 사람들의 결과물을 검토하고 판단하는 데 더 많은 시간을 씁니다. 병목은 구현이 아니라 판단으로 이동했습니다." },
      { q: "PM·엔지니어가 프로토타입을 들고 올 때?", a: "반갑습니다. 조잡하더라도 실제 프로토타입이 있으면 팀이 같은 그림을 보고 이야기할 수 있습니다. 단, '만들 수 있는 것'과 '필요한 것'을 혼동하지 않는 것이 제 역할입니다." },
      { q: "주니어 디자이너에게 어떤 역량을?", a: "AI 전문가가 되라고 하지 않겠습니다. 문제 정의, 커뮤니케이션, 의사결정 영향력을 키우세요. 커리어가 정체되는 이유는 화면을 못 그려서가 아닙니다." },
      { q: "PM·엔지니어링과의 관계는 어떻게 변했나요?", a: "디자인이 아이디어의 유일한 주인이 아니게 되었습니다. 아이러니하게도 AI는 협업의 중요성을 줄인 것이 아니라 오히려 더 크게 만들었습니다." },
    ],
  ...
  },
  {
    ...
    layout: "typo",
    quadrants: [
      { q: "AI 이후 루틴에서 가장 크게 바뀐 것은?", a: "원시 데이터를 먼저 AI에 입력해 액션 아이템을 생성합니다. 기초 데이터 처리에서 벗어나 고차원적인 의사결정에 에너지를 집중할 수 있게 되었습니다." },
      { q: "PM·엔지니어가 프로토타입을 들고 올 때?", a: "환영합니다. 실제 프로토타입이 있으면 요구사항 명확화와 정렬에 매우 유용합니다. 다만 AI가 생성한 디자인에서 불필요한 복잡성이 도입되는 경우를 자주 발견합니다." },
      { q: "주니어 디자이너에게 어떤 역량을?", a: "직군 간 융합 역량에 집중하세요. 바이브 코딩 툴로 엔지니어링 워크플로우를 이해하고, PM처럼 사고하며 비즈니스 니즈를 파악하는 역량을 키우세요." },
      { q: "PM·엔지니어링과의 관계는 어떻게 변했나요?", a: "일상적인 협업은 아직 크게 바뀌지 않았습니다. 하지만 역할 경계가 흐려질 미래를 향해 나아가고 있습니다." },
    ],
  ...
  },
  {
    ...
    layout: "typo",
    quadrants: [
      { q: "AI 이후 루틴에서 가장 크게 바뀐 것은?", a: "이제 코드로 프로토타입을 만듭니다. 실제 플로우를 구현하고 같은 날 테스트합니다. 하루가 픽셀 다듬기에서 경험 아래의 로직과 행동을 설계하는 것으로 이동했습니다." },
      { q: "PM·엔지니어가 프로토타입을 들고 올 때?", a: "위협이 아니라 출발점으로 받아들입니다. 제가 가져오는 것은 '보기 좋게 만드는 것'이 아니라, 실제 사람에게 실제로 작동하는지 판단하는 능력입니다." },
      { q: "주니어 디자이너에게 어떤 역량을?", a: "AI와 산출물 속도 경쟁을 멈추세요. 판단 레이어를 쌓으세요 — 시스템 사고, 행동과 로직을 설계하는 능력, 그리고 취향." },
      { q: "PM·엔지니어링과의 관계는 어떻게 변했나요?", a: "역할 자체가 변했습니다. 디자이너도 코드를 쓰고, PM은 직접 프로토타입을 만들고, 엔지니어는 PRD를 만들어냅니다. 처음엔 혼란스러웠지만 더 강한 팀이 되었습니다." },
    ],
  ...
  },
  {
    ...
    layout: "typo",
    quadrants: [
      { q: "AI 이후 루틴에서 가장 크게 바뀐 것은?", a: "디자인이 여러 플랫폼에 분산되었습니다. 디자인 시스템은 Figma에, 개발 준비가 된 화면들은 GitHub에. 여러 툴에 걸쳐 유지 관리하는 것이 가장 큰 변화였습니다." },
      { q: "PM·엔지니어가 프로토타입을 들고 올 때?", a: "정말 반갑습니다. 빠르게 잠재적인 플로우를 생성하고, 한 세션에서 논의하고 반복할 수 있습니다. 이제 제 브랜치를 가진 디자이너이고, 엔지니어들이 저에게 프로토타입을 보내줍니다." },
      { q: "주니어 디자이너에게 어떤 역량을?", a: "UX 기초를 이해하는 데 집중하세요. 하이파이 화면은 몇 분 안에 만들 수 있습니다. 하지만 그것을 제품의 사용 사례에 맞는 가장 직관적인 경험으로 만드는 것은 여전히 사람의 역할입니다." },
      { q: "PM·엔지니어링과의 관계는 어떻게 변했나요?", a: "일상적인 루틴은 이제 크게 겹치지만, 각 역할의 핵심 책임은 동일하게 남아 있습니다. 루프 안에는 여전히 사람이 필요한 이유가 있습니다." },
    ],
  ...
  },
  {
    ...
    layout: "typo",
    quadrants: [
      { q: "AI 이후 루틴에서 가장 크게 바뀐 것은?", a: "하루를 AI 툴로 시작하고 마칩니다. 아침에는 열린 작업을 검토하고, 저녁에는 그날의 채팅·이메일·회의 노트를 요약하는 두 번의 브리핑 루틴을 만들었습니다." },
      { q: "PM·엔지니어가 프로토타입을 들고 올 때?", a: "역할 침범이 아니라 협업의 출발점으로 봅니다. 특히 AI 시대에는 명확한 역할 경계가 더 이상 없습니다. 우리 모두 함께 빌더가 될 것입니다." },
      { q: "주니어 디자이너에게 어떤 역량을?", a: "사용자와 고객을 깊이 이해하는 능력입니다. 목표는 디자이너가 모든 결정에 관여하는 것이 아니라, 엔지니어와 PM이 더 강한 디자인 판단력을 갖도록 돕는 것입니다." },
      { q: "PM·엔지니어링과의 관계는 어떻게 변했나요?", a: "관계 자체보다 논의하는 주제와 협업 방식이 바뀌기 시작했습니다. 전통적인 역할 정의에 스스로를 제한해서는 안 됩니다." },
    ],
  ...
  },
  {
    ...
    layout: "typo",
    quadrants: [
      { q: "AI 이후 루틴에서 가장 크게 바뀐 것은?", a: "산출물의 중심이 디자인 파일에서 동작하는 프로토타입으로 옮겨갔습니다. 아이디어가 나오면 바로 코드로 만들어 검증하고, 프로토타입 자체가 살아있는 명세가 됩니다." },
      { q: "PM·엔지니어가 프로토타입을 들고 올 때?", a: "'왜 먼저 만들었나요?'가 아니라 '무엇을 배웠나요?'를 먼저 묻습니다. 피드백이 두 개의 동작하는 화면이 되면, 논쟁이 아니라 의사결정이 됩니다." },
      { q: "주니어 디자이너에게 어떤 역량을?", a: "Problem Framing, Prototyping, Systems Thinking. 가장 빨리 만들고 배우는 팀이 이깁니다. AI 시대 디자이너는 화면을 만드는 사람이 아니라 프로토타입으로 가장 빠르게 학습하는 사람입니다." },
      { q: "PM·엔지니어링과의 관계는 어떻게 변했나요?", a: "직군 간 경계가 흐려졌고 협업의 매개체가 바뀌었습니다. 협업이 느슨해진 것이 아니라, 프로토타입을 중심으로 더 빠르고 구체적으로 바뀌었습니다." },
    ],
  ...
  },
  {
    ...
    layout: "typo",
    quadrants: [
      { q: "AI 이후 루틴에서 가장 크게 바뀐 것은?", a: "코드베이스를 직접 읽을 수 있게 됐습니다. 기술적 가능성을 엔지니어에게 묻지 않고 Claude에게 묻습니다. MCP로 고객 피드백을 자동으로 끌어다 PRD를 직접 만듭니다. 의사결정 속도가 완전히 바뀌었습니다." },
      { q: "코드와 실행에 직접 개입했을 때 팀의 반응은?", a: "엔지니어들 반응은 '고맙긴 한데... 왜?'였습니다. 디자인 리더십도 구현보다 아이디에이션에 집중하라고 했습니다. 트레이드오프는 분명합니다 — 실행에 들어갈수록 문제의 상류에 머무는 시간이 줄어듭니다." },
      { q: "주니어 디자이너에게 어떤 역량을?", a: "'어떤 툴을 배워야 하나?'가 아니라 '어떤 문제를 나보다 잘 아는 사람이 없나?'를 물으세요. 그걸 깊이 판 사람들에게는 그걸 원하는 사람들이 찾아옵니다." },
      { q: "주변 디자인 팀은 어떻게 변화하고 있나요?", a: "팀이 AI에 맞춰 재편되고 있습니다. 리서처들이 가장 빠르게 적응했고, 전통적인 UX 스킬만 있는 디자이너들은 힘들어하고 있습니다. 사라지는 건 프로세스가 아니라 그 루프를 이해하지 못하는 역할입니다." },
    ],
  ...
  },
  {
    ...
    layout: "typo",
    quadrants: [
      { q: "AI가 엔지니어로서 일하는 방식을 어떻게 바꿨나요?", a: "거의 모든 걸 터미널의 Claude Code로 합니다. Penpot으로 디자인 시스템을 구축해 MCP로 연결했습니다 — 엔지니어들이 UI를 만들 때 자동으로 우리 시스템에서 가져오도록. 기다리는 일이 없어졌습니다." },
      { q: "디자이너에게 실제로 필요한 것은 무엇인가요?", a: "'왜'를 설명해줄 수 있는 사람입니다. 1픽셀 조정을 요청하는 게 아니라, 그 이유와 어떤 사용자 행동을 반영하는지 설명해주는 사람. 그때부터 스펙을 구현하는 게 아니라 의도를 이해하게 됩니다." },
      { q: "5년 후에도 디자이너가 필요할까요?", a: "네 — 하지만 더 적은 수가, 역할이 달라질 겁니다. 트렌드와 안목을 가진 관점은 자동화하기 어렵습니다. 모든 팀에 디자인 관점을 가진 한 사람은 필요합니다." },
      { q: "위험한 시나리오는 무엇인가요?", a: "바이브 코딩이 디자인 관점을 가진 사람을 대체한다고 생각하는 팀입니다. 바이브 코딩은 생산 작업을 대체합니다. 사고는 여전히 어딘가에서 나와야 합니다." },
    ],
...
function TypoSlide({ slide, total, index }: { slide: SlideData; total: number; index: number }) {
  return (
    <div style={{
      ...
      justifyContent: "center",
      padding: slide.quadrants ? "0 5vw" : "0 10vw",
    }}>
      {/* Tag / label */}
      {slide.tag && (
        <div style={{
          ...
          textTransform: "uppercase",
          color: T.sienna,
          marginBottom: slide.quadrants ? "clamp(4px, 0.6vh, 8px)" : "clamp(10px, 1.6vh, 20px)",
        }}>
          {slide.tag}
        </div>
      )}
      ...
      <h2 style={{
        ...
        fontSize: slide.quadrants ? "clamp(22px, 4vw, 56px)" : "clamp(42px, 7vw, 96px)",
        fontWeight: 700,
        lineHeight: 1.1,
        color: T.white,
        margin: slide.quadrants ? "0 0 clamp(6px, 1vh, 12px)" : "0 0 clamp(10px, 1.8vh, 24px)",
      ...
      <div style={{
        ...
        height: "2px",
        background: T.sienna,
        marginBottom: slide.quadrants ? "clamp(8px, 1.2vh, 16px)" : "clamp(12px, 2vh, 28px)",
      }} />

      {/* Role / company — supports \n line breaks */}
      {slide.body && !slide.quadrants && (
        <div style={{
          fontFamily: "system-ui, -apple-system, Arial, sans-serif",
      ...
      {slide.quadrants && (
        <div style={{
          ...
          gap: "clamp(16px, 2.8vh, 36px) clamp(32px, 4.5vw, 60px)",
          width: "100%",
          maxWidth: "96em",
          marginTop: "clamp(2px, 0.4vh, 6px)",
        }}>
          {slide.quadrants.map((quad, i) => (
            <div key={i} style={{
              borderLeft: `2px solid rgba(188,113,85,0.4)`,
              ...
              <div style={{
                fontFamily: "Georgia, 'Times New Roman', serif",
                fontSize: "clamp(20px, 2.55vw, 34px)",
                lineHeight: 1.55,
