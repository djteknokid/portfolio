...
const slides: SlideData[] = [
  ...
  },
  {
    ...
    muteColor: "rgba(255,255,255,0.55)",
    tag: "보너스 인터뷰 — B1 · 김예원",
    title: "만드는 사람에서 필터링하는 사람으로",
    body: "결과물의 양은 폭발적으로 늘었습니다. 그런데 명확성이 함께 늘어난 것은 아닙니다. 병목은 이제 구현이 아니라 판단입니다.",
    layout: "split-top",
    script: `AI 이전에는 생각을 결과물로 만드는 데 시간을 썼습니다.\n\n지금은 다른 사람들이 만들어 온 결과물을 검토하고 판단하는 데 더 많은 시간을 씁니다.\n\n어떤 의미에서는 만드는 사람에서 필터링하는 사람으로 역할이 바뀌었습니다.\n\n병목은 아이디어를 구현하는 것이 아니라 어떤 아이디어가 실제로 가치 있는지 판단하는 것입니다.\n\n---\n\n디자인 결정에 대한 책임은 여전히 디자이너가 가져가야 합니다.\n\n가장 좋은 협업은 모두가 아이디어를 제안하되, 최종 의사결정의 책임 주체는 처음부터 명확할 때 이루어집니다.\n\n---\n\n커리어가 정체되는 이유는 화면을 못 그려서가 아니라, 똑똑한 사람들을 한 방향으로 정렬시키지 못해서입니다.\n\n아이러니하게도 AI는 협업의 중요성을 줄인 것이 아니라 오히려 더 크게 만들었습니다.`,
  },
  {
    id: 52,
    image: `${BASE}/ch14-coordination-era.png`,
  ...
  },
  {
    ...
    textColor: T.white,
    muteColor: "rgba(255,255,255,0.55)",
    tag: "보너스 인터뷰 — B2 · Wenyang Mu",
    title: "AI를 주요 파트너로",
    body: "원시 데이터를 먼저 AI에 입력해 액션 아이템을 생성합니다. 역할 경계가 흐려질 미래를 향해 나아가고 있습니다.",
    layout: "split-top",
    script: `일상적인 워크플로우는 이제 AI를 주요 파트너로 삼아 시작합니다.\n\n원시 데이터를 AI에 입력해 명확하고 근거 있는 액션 아이템을 생성합니다.\n\n기초 데이터 처리에서 벗어나 고차원적인 의사결정에 에너지를 집중할 수 있게 되었습니다.\n\n---\n\nAI가 생성한 디자인에서 불필요한 복잡성이 도입될 때 실행 측면의 격차를 자주 발견합니다.\n\n---\n\n기술적 역량: GitHub와 Claude Code 같은 바이브 코딩 툴을 배워 엔지니어링 워크플로우를 이해하세요.\n\n프로덕트 씽킹: PM처럼 사고하고 훈련하여 사용자 공감을 넘어 비즈니스 니즈를 이해하세요.\n\n일상적인 협업은 아직 크게 바뀌지 않았지만, 역할 경계가 흐려질 미래를 향해 나아가고 있습니다.`,
  },
  {
    id: 54,
    image: `${BASE}/ch14-coordination-era.png`,
  ...
  },
  {
    ...
    textColor: T.white,
    muteColor: "rgba(255,255,255,0.55)",
    tag: "보너스 인터뷰 — B3 · Yuha Kim",
    title: "판단 레이어를 쌓으세요",
    body: "AI와 산출물 속도 경쟁은 이길 수 없습니다. 시스템 사고, 행동과 로직을 설계하는 능력, 그리고 취향을 키우세요.",
    layout: "split-top",
    script: `가장 큰 변화는 이제 코드로 프로토타입을 만든다는 점입니다.\n\n하루는 픽셀을 다듬는 것에서 경험 아래에 있는 로직과 행동을 설계하는 것으로 이동했습니다.\n\n---\n\n누군가 이미 동작하는 것을 들고 올 때, 그것은 선물입니다.\n\n제가 가져오는 것은 "내가 유일하게 이것을 보기 좋게 만들 수 있다"가 아닙니다.\n\n그것이 실제 사람에게 실제로 작동하는지 판단하는 능력입니다.\n\n---\n\nAI와 산출물 속도 경쟁을 멈추세요. 이길 수 없고, 어차피 그게 요점이 아니었습니다.\n\n판단 레이어를 쌓으세요 — 시스템 사고, 행동과 로직을 설계하는 능력, 그리고 취향.\n\n산출물에 대한 방어심을 내려놓자, AI는 AI가 대체할 수 없는 부분에 대한 본능을 깨웠습니다.`,
  },
  {
    id: 56,
    image: `${BASE}/ch14-coordination-era.png`,
  ...
  },
  {
    ...
    textColor: T.white,
    muteColor: "rgba(255,255,255,0.55)",
    tag: "보너스 인터뷰 — B4 · Vivian Chu",
    title: "모두가 아이디어를 테이블에 올릴 수 있다",
    body: "디자인이 여러 플랫폼에 분산되었습니다. 열린 마음이 더 풍부한 토론으로 이어집니다. 루프 안에는 여전히 사람이 필요합니다.",
    layout: "split-top",
    script: `디자인 시스템은 여전히 Figma에 있지만, 개발 준비가 된 화면들은 이제 GitHub에 저장됩니다.\n\n여러 툴에 걸쳐 디자인을 유지 관리하는 것이 가장 큰 변화였습니다.\n\n---\n\nUX 디자이너가 아닌 분들이 프로토타입을 들고 토론에 오면 정말 반갑습니다.\n\nPM과 엔지니어의 탐색에 열린 마음을 갖는 것이 더 풍부한 토론으로 이어집니다.\n\n---\n\n하이파이 화면은 바이브 코딩으로 몇 분 안에 만들 수 있습니다.\n\n하지만 그것을 제품의 사용 사례에 맞게 가장 직관적인 경험으로 만드는 것은 여전히 사람의 역할입니다.\n\n루프 안에 여전히 사람이 필요한 이유가 있습니다.`,
  },
  {
    id: 58,
    image: `${BASE}/ch14-coordination-era.png`,
  ...
  },
  {
    ...
    muteColor: "rgba(255,255,255,0.55)",
    tag: "보너스 인터뷰 — B5 · 안인선",
    title: "사용자와 고객을 깊이 이해하는 능력",
    body: "하루를 AI 툴로 시작하고 마칩니다. 전통적인 역할 정의에 스스로를 제한해서는 안 됩니다.",
    layout: "split-top",
    script: `하루를 AI 툴로 시작하고 마칩니다.\n\n아침에는 열린 작업을 검토하고, 저녁에는 그날의 채팅, 이메일, 회의 노트를 요약합니다.\n\n---\n\n누군가 이미 만들어진 것을 들고 오면, 저는 그것을 제 역할에 침범하는 것으로 보지 않습니다.\n\n협업의 출발점으로 봅니다.\n\n전통적인 역할 정의에 스스로를 제한해서는 안 된다고 생각합니다.\n\n---\n\n계속해서 관련성을 유지할 역량은 사용자와 고객을 깊이 이해하는 능력입니다.\n\n목표는 디자이너가 모든 결정에 관여하는 것이 아닙니다.\n\n엔지니어와 PM이 더 강한 디자인 판단력을 갖도록 돕는 것입니다.`,
  },
  {
    id: 60,
    image: `${BASE}/ch14-coordination-era.png`,
  ...
  },
  {
    ...
    muteColor: "rgba(255,255,255,0.55)",
    tag: "보너스 인터뷰 — B6 · 오상영",
    title: "프로토타입으로 가장 빠르게 학습하는 사람",
    body: "산출물의 중심이 디자인 파일에서 동작하는 프로토타입으로 옮겨갔습니다. AI 시대 디자이너는 화면을 만드는 사람이 아닙니다.",
    layout: "split-top",
    script: `예전에는 리서치 → 와이어프레임 → 하이파이 → 핸드오프 순서였다면,\n\n지금은 아이디어가 나오면 바로 코드로 만들어 검증합니다.\n\n프로토타입 자체가 살아있는 명세(living spec)가 됩니다.\n\n---\n\n"왜 먼저 만들었나요?"가 아니라 "무엇을 배웠나요?"를 먼저 묻습니다.\n\n피드백이 말이 아니라 비교 가능한 두 개의 동작하는 화면이 되면,\n\n논쟁이 아니라 의사결정이 됩니다.\n\n---\n\nProblem Framing, Prototyping, Systems Thinking.\n\n가장 빨리 만들고 배우는 팀이 이깁니다.\n\nAI 시대의 디자이너는 화면을 만드는 사람이 아니라, 프로토타입으로 가장 빠르게 학습하는 사람입니다.`,
  },
  {
    id: 62,
    image: `${BASE}/ch14-coordination-era.png`,
  ...
  },
  {
    ...
    muteColor: "rgba(255,255,255,0.55)",
    tag: "보너스 인터뷰 — B7 · 김찬",
    title: "어떤 문제를 나보다 잘 아는 사람이 없나?",
    body: "코드베이스를 직접 읽을 수 있게 됐습니다. 팀이 말 그대로 AI에 맞춰 재편되고 있습니다.",
    layout: "split-top",
    script: `가장 큰 변화는 코드베이스를 직접 읽을 수 있게 됐다는 겁니다.\n\n예전에는 기술적으로 무엇이 가능한지 알려면 엔지니어에게 물어봐야 했습니다.\n\n지금은 Claude한테 물어봅니다. 의사결정 속도가 완전히 바뀌었습니다.\n\n---\n\n2년 동안 함께 시작한 디자이너의 절반 이상이 바뀌었습니다.\n\n들어오는 사람들은 다릅니다 — 커뮤니케이션 잘하고, 전략적으로 생각하고, Claude Code는 당연히 씁니다.\n\n---\n\n잘 버티고 있는 디자이너들은 자기가 잘하는 구체적인 무언가를 찾은 사람들입니다.\n\n스스로에게 물어야 할 질문은 '어떤 툴을 배워야 하나?'가 아닙니다.\n\n'어떤 문제를 나보다 잘 아는 사람이 없나?' 거기서 시작하세요.`,
  },
  {
    id: 64,
    image: `${BASE}/ch14-coordination-era.png`,
  ...
  },
  {
    ...
    muteColor: "rgba(255,255,255,0.55)",
    tag: "보너스 인터뷰 — B8 · 태호 김",
    title: "모든 팀에는 디자인 관점을 가진 한 사람이 있어야 합니다",
    body: "바이브 코딩이 그 사람을 대체하지는 않습니다. 생산 작업을 대체하는 겁니다. 사고는 여전히 어딘가에서 나와야 합니다.",
    layout: "split-top",
    script: `거의 모든 걸 터미널의 Claude Code로 합니다.\n\n의사결정 속도가 완전히 달라졌고, 기다리는 일이 없어졌습니다.\n\nPenpot으로 디자인 시스템을 구축한 다음 MCP로 연결했습니다. 엔지니어들이 Claude Code로 UI를 만들 때 자동으로 우리 시스템에서 가져오도록요.\n\n---\n\n'왜'를 설명해줄 수 있는 사람이 필요합니다.\n\n디자이너가 그 이유를 설명해줄 수 있을 때 — 사용자 리서치, 보호하려는 엣지 케이스, 만들려는 경험 — 모든 게 달라집니다.\n\n---\n\n모든 팀에는 디자인 관점을 가진 한 사람이 있어야 합니다.\n\n바이브 코딩이 그 사람을 대체한다고 생각하는 팀이 위험합니다.\n\n바이브 코딩은 생산 작업을 대체합니다. 사고는 여전히 어딘가에서 나와야 합니다.`,
  },
];
