...
const slides: SlideData[] = [
  ...
  /* ── CH 10 ── */
  {
    ...
    layout: "split-top",
    script: `이 신호는 저에게 가장 개인적으로 와닿는 신호입니다.\n\n왜냐하면 제가 직접 경험했기 때문입니다.\n\n제 커리어 대부분 동안\n\n제품 팀은 전문성(Specialization)을 중심으로 구성되어 있었습니다.\n\nPM은 요구사항을 정의했습니다.\n\n디자이너는 디자인을 했습니다.\n\n엔지니어는 개발을 했습니다.\n\n물론 서로 겹치는 부분은 있었습니다.\n\n하지만 기본적으로는 모두가 알고 있었습니다.\n\n내 역할이 어디서 시작되고,\n\n어디서 끝나는지.\n\n솔직히 말하면,\n\n그 경계는 누군가가 완벽한 구조라고 생각해서 만들어진 것이 아니었습니다.\n\n그 경계를 넘는 비용이 너무 컸기 때문입니다.\n\n디자인 툴을 배우는 데도 시간이 걸렸습니다.\n\n개발을 배우는 데도 시간이 걸렸습니다.\n\n프로토타입을 만드는 데도 시간이 걸렸습니다.\n\n모든 것이 어렵고 비쌌습니다.\n\n그 마찰이 자연스럽게 역할의 경계를 만들었습니다.\n\n그런데 지금은 어떨까요?\n\n그 마찰이 사라지고 있습니다.\n\nPM은 프로토타입을 들고 회의에 들어옵니다.\n\n엔지니어는 UX 피드백을 합니다.\n\n디자이너는 코드를 작성합니다.\n\n리서처는 제품 컨셉을 만듭니다.\n\n모두가 서로의 영역으로 들어가기 시작했습니다.\n\n그리고 개인적으로 저는 그것이 좋은 일이라고 생각합니다.\n\n제가 경험한 최고의 팀들은\n\n오히려 그런 팀들이었습니다.\n\n코드를 이해하는 디자이너.\n\n프로토타입을 만드는 PM.\n\n제품 감각이 있는 엔지니어.\n\n그런 팀들은 빠르게 움직입니다.\n\n그래서 저는 역할의 겹침 자체가 문제라고 생각하지 않습니다.\n\n오히려 기회라고 생각합니다.\n\n문제는 그 다음에 발생합니다.`,
  },
  {
    id: 28,
    ...
    layout: "split-top",
    script: `회의 하나를 상상해 보겠습니다.\n\nPM은 사용자 플로우를 보고 있습니다.\n\n디자이너는 인터랙션 품질을 보고 있습니다.\n\n엔지니어는 기술적 구현 가능성을 보고 있습니다.\n\n리서처는 사용자 행동을 생각하고 있습니다.\n\n모두가 같은 화면을 보고 있습니다.\n\n그런데 모두가 다른 이야기를 하고 있습니다.\n\n그리고 재미있는 건,\n\n누구도 틀리지 않았다는 점입니다.\n\n모두가 유용한 관점을 제공하고 있습니다.\n\n문제는 다른 곳에 있습니다.\n\n아무도 지금 어떤 결정을 내려야 하는지 합의하지 않았다는 것입니다.\n\n저는 이런 회의에 정말 많이 들어가 봤습니다.\n\n아마 여러분도 경험해 보셨을 겁니다.\n\n대화는 계속 맴돕니다.\n\n사람들은 서로의 말을 놓칩니다.\n\n회의는 끝납니다.\n\n그런데 이상하게도\n\n아무도 결정이 내려졌다고 느끼지 못합니다.\n\n그 순간 저는 한 가지를 깨달았습니다.\n\n역할은 흐려졌습니다.\n\n그런데 커뮤니케이션은 그만큼 진화하지 않았습니다.\n\n예전에는 모두가 자기 영역 안에 있었기 때문에\n\n구조 자체가 정렬(Alignment)을 만들어 주었습니다.\n\n하지만 이제는 다릅니다.\n\n모두가 어디에나 기여할 수 있습니다.\n\n그렇다면 정렬은 자연스럽게 생기지 않습니다.\n\n의도적으로 만들어야 합니다.\n\n그리고 그것은 완전히 다른 문제입니다.\n\n왜냐하면 이제 질문이 바뀌었기 때문입니다.\n\n예전 질문은\n\n"이건 누가 담당하지?"\n\n였습니다.\n\n지금 질문은\n\n"우리는 어떻게 결정하지?"\n\n입니다.\n\n저는 이것이 두 번째 신호가 중요한 이유라고 생각합니다.\n\n제품 팀을 구조화하던 경계가\n\n점점 사라지고 있습니다.\n\n그런데 우리는 아직\n\n그 자리를 무엇이 대체해야 하는지 완전히 알아내지 못했습니다.\n\n그리고 그것이 세 번째 신호로 이어집니다.`,
  },
  ...
  /* ── CH 11 ── */
  {
    ...
    layout: "split-top",
    script: `이 세 가지 신호 중에서\n\n저를 가장 설득한 신호가 있다면\n\n아마 이것일 겁니다.\n\n왜냐하면 너무 단순하기 때문입니다.\n\n저는 특별한 분석을 한 것이 아닙니다.\n\n그냥 들었습니다.\n\n제품 팀 주변에 충분히 오래 있다 보면\n\n비슷한 이야기를 계속 듣게 됩니다.\n\n내 회사만의 이야기가 아닙니다.\n\n슬랙 커뮤니티.\n\n컨퍼런스 복도.\n\n링크드인.\n\n디자인 커뮤니티.\n\nPM 커뮤니티.\n\n어디를 가도 비슷한 불만이 들립니다.\n\n그런데 어느 순간부터\n\n흥미로운 변화가 생겼습니다.\n\n불만이 바뀌기 시작했습니다.\n\n제 커리어 대부분 동안\n\n사람들의 불만은 항상 비슷했습니다.\n\n디자이너가 부족하다.\n\n엔지니어가 부족하다.\n\n리소스가 부족하다.\n\n시간이 부족하다.\n\n무엇을 만들어야 하는지는 알고 있다.\n\n그런데 만들 사람이 부족하다.\n\n이것이 병목이었습니다.\n\n실행(Execution).\n\n수년 동안.\n\n어쩌면 수십 년 동안.\n\n그런데 요즘 사람들의 이야기를 들어보세요.\n\n선택지가 너무 많다.\n\n사람마다 의견이 다르다.\n\n같은 결정을 계속 반복해서 논의한다.\n\n매주 방향이 바뀐다.\n\n엄청 많이 만들고 있는데 앞으로 나아가는 느낌이 없다.\n\n회의가 끝났는데도 무엇을 결정했는지 모르겠다.\n\n차이가 들리시나요?\n\n예전 불만은 이랬습니다.\n\n"우리는 이것을 만들 수가 없다."\n\n지금 불만은 이렇습니다.\n\n"우리는 이것에 합의할 수가 없다."\n\n예전 불만은 부족함(Scarcity)이었습니다.\n\n지금 불만은 넘쳐남(Abundance)입니다.\n\n그리고 저는 이것이 우연이라고 생각하지 않습니다.\n\n왜냐하면 불만은 보통 증상이기 때문입니다.\n\n불만은 마찰이 어디에 있는지 알려줍니다.\n\n불만은 병목이 어디에 있는지 알려줍니다.\n\n불만은 시스템이 어디에서 느려지고 있는지 알려줍니다.\n\n그래서 불만이 바뀌면,\n\n병목도 함께 바뀌는 경우가 많습니다.\n\n바로 그 점이 제 관심을 끌었습니다.\n\n왜냐하면 시장은 오랫동안 실행력을 원했기 때문입니다.\n\n더 많은 빌더.\n\n더 많은 디자이너.\n\n더 많은 엔지니어.\n\n더 많은 생산 능력.\n\n그런데 점점 시장이 다른 것을 원하고 있다는 느낌을 받았습니다.\n\n명확성.\n\n정렬(Alignment).\n\n공유된 이해(Shared Understanding).\n\n의사결정(Decision Making).\n\n더 많이 만드는 사람이 아니라,\n\n무엇이 중요한지 팀이 결정하도록 돕는 사람.\n\n그런 사람들이 필요해지고 있었습니다.\n\n그리고 이 관찰을\n\n앞선 두 가지 신호와 연결해 보았습니다.\n\n결과물은 풍부해지고 있다.\n\n역할의 경계는 흐려지고 있다.\n\n그리고 불만은 바뀌고 있다.\n\n세 개의 신호가\n\n모두 같은 방향을 가리키고 있었습니다.\n\n그리고 그때 처음으로 이런 생각이 들었습니다.\n\n어쩌면 우리는\n\n전혀 다른 시대에 들어서고 있는 것 아닐까?\n\n제가 왜 그렇게 생각하는지\n\n이제 보여드리겠습니다.`,
  },
